...
for ($chnum = $i = 0; $i < count($asmfile); $i++) {
	...
	} else if (strpos($line, "\tsnd_ret") === 0 || strpos($line, "\tsnd_loop ") === 0 || strpos($line, "\tchan_stop") === 0) {
		outraw($line);
